            ...
            <ul class="nav navbar-nav">
				...
				<li class="active" class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="order_completed_manage.php">已处理订单</a></li>
                    </ul>
                </li>
...
<?php 	
	...
	foreach($res1 as $row1){
		...
		echo "<tr>
			...
			<td></td>
			<td>
				<form action='order_manage.php?orderid={$row['orderID']}' method='POST'>
				<input type='submit' value='接单' class='btn btn-default'>
				</form>
			</td>
		</tr>";
